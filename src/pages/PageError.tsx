      ...
      C360.647,451.083,349.251,457.661,338.164,454.689z" />
        ...
        s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
          ...
          278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928         " />
                    ...
                    <div className="col-md-6 align-self-center" style={{ color: 'Black' }}>
                        <h1>404</h1>
                        <h2>{Translate("ErroPage.Title", false)}</h2>
                        <p>
                            {Translate("ErroPage.Msg", false)}
                        </p>
                        <button className="btn btn-outline-primary" onClick={() => Navigate("/")}>{Translate("ErroPage.BtnText", false)}</button>
                    </div>
                </div>
            </div>
        </>
